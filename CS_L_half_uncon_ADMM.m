function [x, output] = CS_L_half_uncon_ADMM(A, b, pm)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%         min_x .5||Ax-b||^2 + lambda |x|_1/2 ^1/2             %%%  
%%%                                                                     %%%
...
u       = x;
x_old = x;
obj         = @(x) .5*norm(A*x-b)^2 + lambda*sum(x.^(0.5));
output.pm   = pm;
c = 0.5;
...
for it = 1:maxit                
    ...
    x = shrink_half(x_old+c*A'*(b-A*x_old),lambda,c);
